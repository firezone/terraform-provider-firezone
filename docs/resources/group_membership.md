...
- `actor_id` (String) ID of the Actor to add to the Group.
- `group_id` (String) ID of the Group.

### Read-Only

- `id` (String) Composite ID in the form "{group_id}/{actor_id}" - the API has no dedicated membership ID.
